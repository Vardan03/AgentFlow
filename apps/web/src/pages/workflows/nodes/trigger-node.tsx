...
export function TriggerNode({ selected }: { selected?: boolean; data: any }) {
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-green-600/30 bg-green-500/10 rounded-t-md">
        ...
        <span className="text-xs font-semibold text-green-400 uppercase tracking-wide">Trigger</span>
      </div>
      <div className="px-3 py-2.5">
        <p className="text-sm font-medium">Manual Trigger</p>
        <p className="text-xs text-muted-foreground mt-0.5">Starts the workflow manually</p>
      </div>
      <Handle
        type="source"
